...
(let* ((bg "#212337")
      (err "#f16c75")
      (err-container "#93060f")
      (on-background "#ffffff")
      (on-err "#e6e1e5")
      (on-err-container "#ffffff")
      (on-primary "#000000")
      (on-primary-container "#e6e1e5")
      (on-secondary "#000000")
      ...
      (outline-color "#8bc1c1")
      (outline-variant "#509696")
      (primary "#37f499")
      (primary-container "#00994f")
      (secondary "#04d1f9")
      (secondary-container "#007e97")
      (shadow "#000000")
      (surface "#212337")
      (surface-container "#2c2f4a")
      (surface-container-high "#323554")
      (surface-container-highest "#383b5d")
      (surface-container-low "#272941")
      (surface-container-lowest "#212337")
      (surface-variant "#2b2d47")
      (tertiary "#a48cf2")
      (tertiary-container "#280891")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#a48cf2")
      (on-success "#e6e1e5")
      (success-container "#280891")
      (on-success-container "#ffffff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#37f499")
      (primary-fixed-dim "#00994f")
      (secondary-fixed "#04d1f9")
      (secondary-fixed-dim "#007e97")
      (tertiary-fixed "#a48cf2")
      (tertiary-fixed-dim "#280891")
      (on-primary-fixed "#000000")
      (on-primary-fixed-variant "#e6e1e5")
